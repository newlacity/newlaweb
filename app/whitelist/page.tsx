...
import { Shield, CheckCircle, XCircle, Clock, User, Trophy, LogOut } from "lucide-react"

const quizQuestions = [
  {
    id: 1,
    question: "Quels comportements sont autorisés ?",
    options: ["Respecter les joueurs et favoriser l'immersion RP", "Insulter OOC", "Forcer les joueurs à agir contre leur volonté"],
    correct: 0
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: ["Pour éviter les bugs", "Pour préserver l'immersion RP", "Pour gagner plus d'argent"],
    correct: 1
  },
  {
    id: 4,
    question: "Quel langage est recommandé en jeu ?",
    options: ["Adapté au RP et respectueux", "Argot, insultes IRL", "Aucun filtre"],
    correct: 0
  },
  {
    id: 5,
    question: "Pourquoi aider les nouveaux joueurs ?",
    options: ["Pour avoir plus d'amis", "Pour renforcer la communauté et l'immersion", "Pour obtenir des récompenses"],
    correct: 1
  },
  {
    id: 6,
    question: "Quelles sanctions existent ?",
    options: ["Avertissement", "Jail RP / kick", "Ban temporaire ou permanent", "Toutes"],
    correct: 3
  },
  {
    id: 7,
    question: "Qu'est-ce que le powergaming ?",
    options: ["Utiliser des infos hors RP", "Faire des actions irréalistes ou impossibles", "Tuer sans raison"],
    correct: 1
  },
  {
    id: 8,
    question: "Exemple de metagaming :",
    options: ["Lire le chat Twitch et l'utiliser en RP", "Négocier avec un PNJ", "Se cacher derrière une voiture"],
    correct: 0
  },
  {
    id: 9,
    question: "Pourquoi privilégier la qualité du RP ?",
    options: ["Pour gagner plus d'argent", "Pour enrichir les scènes et l'immersion", "Pour raccourcir les scènes"],
    correct: 1
  },
  {
    id: 10,
  ...
  },
  {
    ...
    options: ["Improviser", "Faire des actes gratuits (free kill, torture inutile)", "Négocier avec la police"],
    correct: 1
  },
  {
    id: 16,
  ...
  },
  {
    ...
    options: ["Coopérer et jouer la scène", "Quitter le serveur", "Insulter la police OOC"],
    correct: 0
  },
  {
    id: 19,
  ...
  },
  {
    ...
    options: ["Respecter un code d'honneur interne", "Pouvoir tout faire librement", "Jouer solo"],
    correct: 0
  },
  {
    id: 21,
    question: "Pour créer une entreprise, il faut :",
    options: ["Faire un dossier", "Payer en jeu seulement", "Demander à un ami"],
    correct: 0
  },
  {
    id: 22,
  ...
  },
  {
    ...
    options: ["1 jour", "Selon le règlement (ex. 1 semaine)", "Pas obligatoire"],
    correct: 1
  },
  {
    id: 24,
  ...
  },
  {
    ...
    options: ["Respecter les lois RP", "Frauder pour survivre", "Ne rien déclarer"],
    correct: 0
  },
  {
    id: 26,
  ...
  },
  {
    ...
    options: ["Fusion d'entreprises", "Employer des PNJ", "Recruter sans contrat"],
    correct: 0
  },
  {
    id: 29,
  ...
  },
  {
    ...
    options: ["Comptabilité et justification", "Dépenser sans compter", "Cacher l'argent"],
    correct: 0
  },
  {
    id: 31,
    question: "Différence des sanctions général / illégal ?",
    options: ["Général = avertissements/staff ; Illégal = conséquences RP", "Les deux identiques", "Aucun suivi"],
    correct: 0
  },
  {
    id: 32,
  ...
  },
  {
    ...
    options: ["Aider les nouveaux joueurs", "Organiser une faction", "Les deux"],
    correct: 2
  },
  {
    id: 37,
  ...
  },
  {
    ...
    options: ["Braquages (participants, horaires)", "Entreprises (lois, dossiers)", "Les deux"],
    correct: 2
  },
  {
    id: 39,
  ...
  {
    id: 40,
    question: "Situation mixte : Un gang braque une société pendant qu'un joueur RP citoyen signale l'événement →",
    options: ["3 règlements appliqués (général, illégal, sociétés)", "Aucun règlement"],
    correct: 0
  }
]
...
export default function WhitelistPage() {
  ...
  const checkWhitelistStatus = async (userId: string) => {
    try {
      ...
      console.error('Erreur lors de la vérification du statut whitelist:', error)
    }
  }
        ...
        <div className="max-w-md mx-auto px-6 py-12">
          <div className="text-center">
            ...
            <p className="text-white/70 mb-8">
              Connectez-vous avec Discord pour accéder au quiz RP et obtenir l'accès whitelist
            </p>
            <button
      ...
      <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 flex items-center justify-center">
        <div className="max-w-md mx-auto px-6 py-12 text-center">
          ...
          <p className="text-white/70 mb-6">
            Félicitations ! Vous avez réussi le quiz RP et obtenu l'accès whitelist.
          </p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 flex items-center justify-center">
        <div className="max-w-md mx-auto px-6 py-12 text-center">
          ...
          <h1 className="text-3xl font-bold text-white mb-4">
            ...
            <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4 mb-6">
              <p className="text-green-400 text-sm">
                Félicitations ! Vous avez réussi le quiz. Le rôle whitelist va être ajouté à votre compte Discord.
              </p>
            </div>
          ) : (
            <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-4 mb-6">
              <p className="text-red-400 text-sm">
                Score insuffisant. Vous devez obtenir au moins 30/40 pour passer.
              </p>
            </div>
          )}
          <div className="space-y-3">
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 flex items-center justify-center">
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="text-center">
          ...
          <p className="text-white/70 mb-8">
                         Bienvenue {user?.username} ! Pour obtenir l'accès whitelist, vous devez réussir un quiz de 40 questions sur les règles RP.
          </p>
